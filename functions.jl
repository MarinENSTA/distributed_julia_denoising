...
function  bigStructMotionConstruction(sizeIm, nb_frame)
    ...
    for i in 1: sizeIm
        ...
        for j in 1:sauv
            ...
            var = matread("Motion/M$(i-sauv+j-1)$(i).mat");
            motionTab[j] = copy(var["Pmat"]);

            var = matread("Motion/Norm$(i-sauv+j-1)$(i).mat");
        ...
        for j = 1:nb
            ...
            var = matread("Motion/M$(i+nb-j+1)$(i).mat");
            motionTab[j+sauv] = copy(var["Pmat"]);

            var = matread("Motion/Norm$(i+nb-j+1)$(i).mat");
