...
function prox_Dist(imblurnoisy, imbar, param, nb_frame, eta, alpha, alpha0, structMotion, T, im_start, im_end, comm)
        ...
        time1_end = @elapsed begin
            ...
            #@suppress begin
                timeO_end = @elapsed begin
                    localOptimization(xstruct, imq, y, eta, alpha, alpha0, structMotion, BigBetaArrayI, N1_x, N2_x, xmin,xmax, gammaj, T, nb_frame, im_start, im_end);
                end
            #end
